          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className="lg:w-[570px]">
                ...
                <p className="text_para"> At CareConnect, we make healthcare simple and stress-free. 
                  Booking appointments with trusted doctors is quick and easy—whether for a routine check-up or urgent care. 
                  Your health journey starts with just a few clicks.</p>
                <Link to="/doctors">
